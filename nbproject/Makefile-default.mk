...
${OBJECTDIR}/CRC16.o: CRC16.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  CRC16.c  -o ${OBJECTDIR}/CRC16.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/CRC16.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -no-legacy-libc  -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/include" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/peripheral_24F" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/PIC24F/h" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic/h" -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/CRC16.o: CRC16.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/CRC16.o.d 
	@${RM} ${OBJECTDIR}/CRC16.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  CRC16.c  -o ${OBJECTDIR}/CRC16.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/CRC16.o.d"        -g -omf=elf -no-legacy-libc  -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/include" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/peripheral_24F" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/PIC24F/h" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic/h" -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/CRC16.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/WiMODSendUartMsg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/WiMODSendUartMsg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -no-legacy-libc  -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/include" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/peripheral_24F" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/PIC24F/h" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic/h"  -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x825 -mreserve=data@0x826:0x84F   -Wl,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/WiMODSendUartMsg.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/WiMODSendUartMsg.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -no-legacy-libc  -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/include" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/peripheral_24F" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/PIC24F/h" -I"../../../../../Program Files (x86)/Microchip/xc16/v1.25/support/generic/h" -Wl,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
